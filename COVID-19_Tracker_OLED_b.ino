 ...
 #include "images.h"  // Include custom images
  ...
  const char* ssid = "SSID Name";              //WIFI SSID Name                             
  const char* password =  "WIFI Password";        //WIFI Password
  const char* host = "api.thingspeak.com";  //We read the data from this host                                   
  const int httpPortRead = 80;                                           
                                                  
  const char* url1 = "/apps/thinghttp/send_request?api_key=LK5RQU6MYGGGBRLVSD";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=D09MKV49G04OY6JJJW96";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=RP67KLK5KKA5XSOW6NXW";   //Recovered
